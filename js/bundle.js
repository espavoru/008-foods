...
eval("var icons = document.querySelectorAll('.hero__icons i');\nvar i = 1;\nsetInterval(function () {\n  i++;\n  var icon = document.querySelector('.hero__icons .change');\n  icon.classList.remove('change');\n\n  if (i > icons.length) {\n    icons[0].classList.add('change');\n    i = 1;\n  } else {\n    icon.nextElementSibling.classList.add('change');\n  }\n}, 4000);\n\n//# sourceURL=webpack:///./src/blocks/hero/hero.js?");
